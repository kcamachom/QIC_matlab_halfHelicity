function [varphi,phi,iota,alpha_RMS,curvature, torsion, n_for_alpha, sigma_max, elongation] = mGarrenBoozerOmnigenity_1layerIt_Frenet_FieldPeriods_alpha(nfp,R0c,R0s,Z0c,Z0s)%,B0_1,B0_2)
